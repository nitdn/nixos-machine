{
  settings = {
    ...
    general = {
      ...
      animationSpeed = 1;
      autoStartAuth = false;
      avatarImage = "/home/ssmvabaa/.face";
      boxRadiusRatio = 1;
      clockFormat = "hh\\nmm";
      clockStyle = "custom";
